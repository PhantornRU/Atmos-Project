                    ...
                    case LeftClickMode.Damage:
                        {
                            ...
                            {
                                //tilesArray.tilesGas[clickTilePosition.x, clickTilePosition.y] = null;
                    ...
                    case LeftClickMode.AddGas:
                        {
                            if (tilesArray.tilesGas[clickTilePosition.x, clickTilePosition.y] != null)
                                try
                                {
                                    ...
                                    tilesArray.tilesGas[clickTilePosition.x, clickTilePosition.y].UpdatePressure(1000f); //добавляем давление
